...
def get_code_explanation(code, language):
    body = {
        "input": f"Explain the following {language} code in beginner-friendly terms. Use a polite tone and start with 'Hello!' Avoid using special characters that may cause issues with speech synthesis.\n\n{code}",
